...
const LoginPage: React.FC = () => {
  ...
  return (
    <div
      ...
      style={{ backgroundImage: 'linear-gradient(rgba(60,60,60,0.3), rgba(60,60,60,0.3)),url(/sut.jpg)' }} 
    >
      {contextHolder}
            ...
            <Form name="login-form" onFinish={onFinish} layout="vertical">
              ...
              <Form.Item>
                <Button
                  type="primary"
                  htmlType="submit"
                  className="w-full bg-[#ff6314] hover:bg-orange-600 text-white font-semibold h-10 rounded-md"
                >
                  เข้าสู่ระบบ
                </Button>
              </Form.Item>
