...
func SeedAllCourses() {
	var (
		...
		credit1_0_2 entity.Credit
		credit2_1_2 entity.Credit
		credit2_1_3 entity.Credit
		credit4_3_3 entity.Credit
		credit4_2_4 entity.Credit
		credit2_0_4 entity.Credit
		credit3_0_6 entity.Credit
		credit4_0_8 entity.Credit
		credit0_3_0 entity.Credit
		credit0_3_3 entity.Credit
		credit1_3_5 entity.Credit
		credit3_3_9 entity.Credit
		credit1_0_0 entity.Credit
		credit8_0_0 entity.Credit
		credit9_0_0 entity.Credit
		credit2_4_8 entity.Credit
		...
		year5 entity.AcademicYear
		year6 entity.AcademicYear
	)
	...
	db.First(&credit1_0_2, "unit = ? AND lecture = ? AND lab = ?", 1, 0, 2)
	db.First(&credit3_3_0, "unit = ? AND lecture = ? AND lab = ?", 3, 3, 0)
	db.First(&credit2_1_2, "unit = ? AND lecture = ? AND lab = ?", 2, 1, 2)
	db.First(&credit4_4_0, "unit = ? AND lecture = ? AND lab = ?", 4, 4, 0)
	db.First(&credit1_0_3, "unit = ? AND lecture = ? AND lab = ?", 1, 0, 3)
	db.First(&credit2_1_3, "unit = ? AND lecture = ? AND lab = ?", 2, 1, 3)
	db.First(&credit4_3_3, "unit = ? AND lecture = ? AND lab = ?", 4, 3, 3)
	db.First(&credit4_2_4, "unit = ? AND lecture = ? AND lab = ?", 4, 2, 4)
	db.First(&credit4_2_4, "unit = ? AND lecture = ? AND lab = ?", 2, 0, 4)
	db.First(&credit4_2_4, "unit = ? AND lecture = ? AND lab = ?", 3, 0, 6)
	db.First(&credit4_0_8, "unit = ? AND lecture = ? AND lab = ?", 4, 0, 8)
	db.First(&credit0_3_0, "unit = ? AND lecture = ? AND lab = ?", 0, 3, 0)
	db.First(&credit0_3_3, "unit = ? AND lecture = ? AND lab = ?", 0, 3, 3)
	db.First(&credit1_3_5, "unit = ? AND lecture = ? AND lab = ?", 1, 3, 5)
	db.First(&credit3_3_9, "unit = ? AND lecture = ? AND lab = ?", 3, 3, 9)
	db.First(&credit1_0_0, "unit = ? AND lecture = ? AND lab = ?", 1, 0, 0)
	db.First(&credit8_0_0, "unit = ? AND lecture = ? AND lab = ?", 8, 0, 0)
	...
	db.First(&year5, "level = ?", "5")
	db.First(&year6, "level = ?", "6")
	...
	courses := []entity.AllCourses{
		...
		{
			Code:            "SCI02 1111",
			EnglishName:     "Fundamental Chemistry I",
			ThaiName:        "เคมีพื้นฐาน 1",
			CurriculumID:    curriculumComEng2566.ID,
			AcademicYearID:  &year6.ID,
			TypeOfCoursesID: 4,
			CreditID:        credit4_0_8.ID,
		},
		{
			Code:            "SCI02 1112",
			EnglishName:     "Fundamental Chemistry Laboratory I",
			ThaiName:        "ปฏิบัติการเคมีพื้นฐาน 1",
			CurriculumID:    curriculumComEng2566.ID,
			AcademicYearID:  &year6.ID,
			TypeOfCoursesID: 4,
			CreditID:        credit0_3_0.ID,
		},
		{
			Code:            "SCI03 1001",
		...
		{
			Code:            "SCI05 1191",
			EnglishName:     "Physics Laboratory I",
			ThaiName:        "ปฏิบัติการฟิสิกส์ 1",
			CurriculumID:    curriculumComEng2566.ID,
			AcademicYearID:  &year6.ID,
			TypeOfCoursesID: 4,
			CreditID:        credit0_3_0.ID,
		...
		{
			Code:            "SCI05 1192",
			EnglishName:     "Physics Laboratory II",
			ThaiName:        "ปฏิบัติการฟิสิกส์ 2",
			CurriculumID:    curriculumComEng2566.ID,
			AcademicYearID:  &year6.ID,
			TypeOfCoursesID: 4,
			CreditID:        credit0_3_0.ID,
		...
		},
		{
			...
			AcademicYearID:  &year6.ID,
			TypeOfCoursesID: 5,
			CreditID:        credit3_3_9.ID,
		},
		{
			Code:            "ENG23 4080",
			EnglishName:     "Computer Engineering Project",
